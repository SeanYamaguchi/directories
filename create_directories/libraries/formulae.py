...
def formula_directory_J_is_equal_to_or_below_directory_I_other_type(dir_I_path:Directory, dir_J_path:Directory) -> bool:
	return True if (dir_J_path.find(dir_I_path) != -1) else False
# def formula_directory_J_is_equal_to_or_below_directory_I(ordered_pair:DirectoryOrderedPair) -> bool:
#	if ((formula_directory_J_is_equal_to_directory_I(ordered_pair)) or formula_directory_J_is_below_directory_I(ordered_pair)):
#		return True
#	else:
#		return False
def formula_directory_J_is_below_directory_I_other_type(dir_I_path:Directory, dir_J_path:Directory) -> bool:
